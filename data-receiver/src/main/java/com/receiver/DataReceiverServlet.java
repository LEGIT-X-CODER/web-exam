...
public class DataReceiverServlet extends HttpServlet {
    ...
    private static final Logger LOG = Logger.getLogger(DataReceiverServlet.class.getName());
    ...
    protected void doPost(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (data == null || data.isBlank()) {
            ...
            resp.getWriter().write("ERROR: Empty data.");
            return;
        }

        try {
            Files.writeString(Paths.get(WORK_DIR, DATA_NAME), data, StandardCharsets.UTF_8);
            resp.getWriter().write("SUCCESS: data.txt saved.");
        } catch (IOException e) {
